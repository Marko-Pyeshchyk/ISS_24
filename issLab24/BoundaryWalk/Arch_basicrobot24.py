...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     basicrobot >> Edge( label='sonardata', **eventedgeattr, decorate='true', fontcolor='red') >> boundary
     ...
     boundary >> Edge(color='blue', style='solid',  decorate='true', label='<cmd &nbsp; disengage &nbsp; >',  fontcolor='blue') >> basicrobot
